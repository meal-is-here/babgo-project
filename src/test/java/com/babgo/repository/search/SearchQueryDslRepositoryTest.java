...
public class SearchQueryDslRepositoryTest extends MockTest {
    ...
    void setup() {
        ...
        List<Search> searches = List.of(
            Search.of(UUID.randomUUID(), regionCode, "치킨나라", chickenCategoryId, "치킨", 4.8, 152, 3, "DELIVERY_AVAILABLE", "OPEN", 37.5665, 126.9780),
            Search.of(UUID.randomUUID(), regionCode, "피자나라치킨공주", chickenCategoryId, "치킨", 4.5, 98, 2, "DELIVERY_AVAILABLE", "OPEN", 37.5666, 126.9781),
            Search.of(UUID.randomUUID(), regionCode, "둘둘치킨", chickenCategoryId, "치킨", 4.6, 210, 1, "DELIVERY_AVAILABLE", "OPEN", 37.5667, 126.9782),

            Search.of(UUID.randomUUID(), regionCode, "피자나라", pizzaCategoryId, "피자", 4.3, 120, 4, "DELIVERY_AVAILABLE", "OPEN", 37.5668, 126.9801),
            Search.of(UUID.randomUUID(), regionCode, "피자스쿨", pizzaCategoryId, "피자", 4.1, 60, 2, "DELIVERY_AVAILABLE", "OPEN", 37.5669, 126.9798),

            Search.of(UUID.randomUUID(), regionCode, "가까운가게", commonCategoryId, "치킨", 4.8, 152, 1, "DELIVERY_AVAILABLE", "OPEN", 37.5665, 126.9780),
            Search.of(UUID.randomUUID(), regionCode, "중간가게", commonCategoryId, "치킨", 4.5, 98, 1, "DELIVERY_AVAILABLE", "OPEN", 37.5710, 126.9780),
            Search.of(UUID.randomUUID(), regionCode, "먼가게", commonCategoryId, "치킨", 4.6, 210, 1, "DELIVERY_AVAILABLE", "OPEN", 37.5765, 126.9830),

            Search.of(UUID.randomUUID(), regionCode, "가게좋아요적음", commonCategoryId, "치킨", 4.8, 50, 2, "DELIVERY_AVAILABLE", "OPEN", 37.5665, 126.9780),
            Search.of(UUID.randomUUID(), regionCode, "가게좋아요중간", commonCategoryId, "치킨", 4.6, 150, 1, "DELIVERY_AVAILABLE", "OPEN", 37.5665, 126.9780),
            Search.of(UUID.randomUUID(), regionCode, "가게좋아요많음", commonCategoryId, "치킨", 4.5, 300, 3, "DELIVERY_AVAILABLE", "OPEN", 37.5665, 126.9780)
        );
